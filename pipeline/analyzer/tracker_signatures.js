const manifest = [ { signature: 'com.google.android.gms.ads', name: 'GAds'},
...
const settings = [ { signature: 'com.google.android.gms.ads.DELAY_APP_MEASUREMENT_INIT', name: 'GAds_Init_Delayed', value: 'true' },
